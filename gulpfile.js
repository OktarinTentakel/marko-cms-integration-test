...
gulp.task('watch', function(){
	...
	watch(['./src/js/**/*.js', './src/marko/**/*.marko'], watchConfig, function(){ sequence('js', function(){ browserSync.reload('*.js'); }) });
	watch(['./src/styl/**/*.styl', './src/marko/**/*.styl'], watchConfig, function(){ sequence('stylus', function(){ browserSync.reload('*.css'); }) });
});
